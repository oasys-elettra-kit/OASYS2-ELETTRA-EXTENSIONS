#under development, in the future we will include the grating efficiency calculation
...
from orangecontrib.shadow4.widgets.gui.ow_optical_element import Output, TriggerToolsDecorator
...
class OWGrating(_OWGrating):
    ...
    icon = "icons/plane_grating_elettra.png"
...
#commented so for the moment wont be added to the module, as it is not yet fully implemented
#add_widget_parameters_to_module(__name__)


""" This part is to be used for quick testing of the widget, without needing 
    to run the whole OASYS. It can be removed when not needed anymore. """
"""
